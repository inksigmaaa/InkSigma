...
export default function Home() {
  return (
    <div className="w-full bg-white mx-auto overflow-hidden">
      ...
      <section id="features" className="w-screen flex items-center justify-center py-20">
      ...
      {/* Roadmap Section */}
      <section id="roadmap" className="w-screen flex items-center justify-center py-20">
        <div className="w-full max-w-screen-xl px-8">
            ...
            <div className="flex gap-[59px] h-full justify-center">
              ...
              <div className="w-[325px] h-[325px] p-8 border border-[#EAEAEA] rounded-3xl flex flex-col">
                ...
                <div className="flex-1 flex flex-col justify-center items-center">
                  ...
                  <Link href="/signup" className="w-[121px] h-[37px] px-4 py-2 rounded-[20px] border border-[#2E2E2E] bg-transparent hover:bg-gray-50 transition-colors flex items-center justify-center">
