          ...
          <div className="space-y-8">
            ...
            <div className="pt-6">
              <button
                ...
                disabled={loading}
                className="mx-auto text-[#3400A3] text-[14px] font-medium hover:text-[#6D28D9] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
