            ...
            <div className="flex items-end gap-4 mb-8">
              ...
              <div className="min-w-[140px]">
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-md text-sm text-gray-600 bg-white focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent cursor-pointer"
                >
