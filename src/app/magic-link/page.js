      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="w-full max-w-[259px] flex flex-col items-center">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col items-center">
            ...
            >
              <span className="w-auto md:w-[83px] h-[21px] opacity-100 rotate-0 font-medium text-[12px] md:text-[14px] leading-[150%] tracking-[0%] text-[#EDEDED]" style={{ fontFamily: 'Public Sans' }}>
