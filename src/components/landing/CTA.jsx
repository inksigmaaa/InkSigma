      ...
      <div className="w-full max-w-screen-xl px-4 md:px-8">
        ...
        <div className="flex items-center justify-center">
          <Link
            ...
            className="min-w-[230px] max-w-full min-h-[44px] px-5 py-2 rounded-[22px] border border-[#2E2E2E] bg-transparent hover:bg-gray-50 transition-colors inline-flex items-center justify-center gap-2 font-[500] text-sm leading-[150%] text-black font-sans whitespace-nowrap"
          >
