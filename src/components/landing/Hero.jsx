      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-end pb-10 md:justify-center px-4 md:px-[151.63px] gap-6">
        ...
        <div className="flex items-center justify-center">
          <Link
            ...
            className="min-w-[230px] max-w-full min-h-[44px] px-5 py-2 rounded-[22px] border border-gray-300 opacity-100 font-medium text-sm leading-[150%] tracking-normal text-black bg-white hover:bg-gray-50 transition-colors shadow-sm font-sans inline-flex items-center justify-center gap-2 whitespace-nowrap"
          >
            <span className="whitespace-nowrap">Start Writing for FREE</span>
            <svg
              width="18"
              height="18"
              viewBox="0 0 18 18"
