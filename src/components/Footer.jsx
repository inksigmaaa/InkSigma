...
import { APP_CONFIG, LOGOS, FOOTER_LINKS } from "@/constants"

export default function Footer() {
  return (
    <footer className="bg-[#F5F5F5] w-full">
      <div className="max-w-[1920px] mx-auto px-6 py-16 min-h-[516px] flex flex-col justify-center">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 max-w-4xl mx-auto">
