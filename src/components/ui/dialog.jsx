  ...
  ({ children, showClose = true, ...props }, ref) => (
    <AlertDialogContent ref={ref} {...props}>
      ...
      {showClose && (
        <DialogClose
          asChild
          className="absolute right-4 top-4 mt-0 h-auto w-auto border-0 bg-transparent p-0 opacity-70 shadow-none  hover:bg-transparent hover:opacity-100 focus:outline-none data-[state=open]:bg-transparent"
        >
