...
const getCachedPublication = async (key) => {
  ...
  try {
    ...
    console.error("[PublicationResolver] Cache get failed:", error.message);
    return null;
  }
};
...
const setCachedPublication = async (key, value) => {
  ...
  try {
    ...
    console.error("[PublicationResolver] Cache set failed:", error.message);
    return false;
  }
};
...
const deleteCachedPublication = async (key) => {
  ...
  try {
    ...
    console.error("[PublicationResolver] Cache delete failed:", error.message);
    return false;
  }
};
